 ...
 * 3, forced decision 5). Contracts, retry/backoff, and the Anthropic driver
 * live here; OpenAI and Gemini drivers land in m4-02 against these same
 * types. This package never stores, reads, or defaults an API key --
 * credentials are a plain argument on every call, supplied by the host
 * process (Handler A or the Brain), never by this package.
 */
