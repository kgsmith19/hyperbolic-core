...
| --- | --- | --- | --- | --- |
| `tools/check.sh` | Deterministic diagnostic scanners and the CLI/dashboard's own test fixtures | `bash tools/check.sh` | 2026-08-12 | pass (local/deterministic, no network dependency) |
