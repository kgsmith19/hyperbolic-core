...
| SR-010 | No module in `netcheck/` may import a package outside the Python 3 standard library. | NFR-001 | Inspection | hyperbolic-core root's `Toolbelt PR Gate` via `tools/check.sh` | done |
