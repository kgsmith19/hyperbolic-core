 ...
 * same precedent apps/toolbelt/apps/prompt-organizer/frontend/e2e/ already
...
// The seeder is Python and stays with the backend suite that also uses it;
// only this browser spec moved to frontend/.
const SEED_SCRIPT = path.join(__dirname, "..", "..", "backend", "tests", "e2e", "seed_dashboard_fixture.py");
