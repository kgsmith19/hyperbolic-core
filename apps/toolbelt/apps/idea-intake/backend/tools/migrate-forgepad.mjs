...
// apps/toolbelt/apps/idea-intake/backend/tests/intake-guards.test.mjs and
...
// bypasses grants and RLS entirely — apps/toolbelt/apps/idea-intake/backend/tests/intake-guards.test.mjs's
...
function printUsage() {
  console.log(
    [
      "Usage: node apps/toolbelt/apps/idea-intake/backend/tools/migrate-forgepad.mjs --acc-root <path> [--dry-run]",
      "",
