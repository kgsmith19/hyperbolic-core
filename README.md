...
Web UI for [lifeos](https://github.com/kgsmith19/lifeos): a React SPA over the
...
Node 24+. `.env` holds only public-by-design values (`VITE_` vars are baked
...
See [AGENTS.md](AGENTS.md) for engineering standards, `gen:api`, and deploy.
