...
| SL-001 | Idea scoring | `idea.score` rows are visible next to each idea on the list page, and a score outside its metric's declared range is rejected. | FR-004, FR-005 | 150 | SL-000 |
