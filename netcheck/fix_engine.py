...
def _get_wifi_fixes() -> List[FixRecommendation]:
    """Get Wi-Fi-related fixes (35% likely)."""
    return [
        FixRecommendation(
            "wifi_channel_5ghz",
...
def _get_router_fixes() -> List[FixRecommendation]:
    """Get router configuration fixes (20% likely)."""
    return [
        FixRecommendation(
...
def _get_modem_fixes() -> List[FixRecommendation]:
    """Get modem/DOCSIS fixes (20% likely)."""
    return [
        FixRecommendation(
            "check_docsis_levels",
...
def _get_nat_fixes() -> List[FixRecommendation]:
    """Get double NAT fixes (7% likely)."""
    return [
        FixRecommendation(
            "verify_bridge_mode",
